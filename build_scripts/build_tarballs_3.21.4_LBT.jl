...
SUITESPARSE_COMPAT_VERSION = "7.2"       
...
#
    ...
    # use LBT, note that the suffix should be set to "_64" in that case, as pointed out by Viral Shah:
    # https://github.com/JuliaPackaging/Yggdrasil/pull/7989#issuecomment-1906918827
...
dependencies = [
    # Basic PETSc installation (with BLAS/LAPACK)
    Dependency("OpenBLAS32_jll"; platforms=filter(Sys.iswindows, platforms)),
